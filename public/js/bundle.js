...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXVyYWV4ZSIsImEiOiJjbGhvcjNqbHYwOW1uM2pwNnA5ZG00NDB2In0.FLYcaX6IodZu3_CWhunGgg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/auraexe/clhor8uvk00lt01r5hpjjbav4',
    // style URL
    scrollZoom: false
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          route = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe';
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000".concat(route),
            data: data
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Your ".concat(type.toUpperCase(), " is updated successfuly"));
          } else {
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51N8nHXLwFOA2EB2ILl9ImLaXPnjxURQCBZKD3GuwHQxAwZ1b5T5FAm75qb3lMItFOcStTuhqMYdEmvtZcupEaAJy00E7trHtJE');
          _context.prev = 1;
          _context.next = 4;
